...
ert_system_domain_ssl_rsa_certificate=$(om --target ${opsmgr_url} \
  ...
  --data '{ "domains": ["*.${ert_system_domain}"] }')
...
perl -pi -e "s|{{ert_system_domain_ssl_cert}}|${ert_system_domain_ssl_cert}|g" ${properties_json_file}
perl -pi -e "s|{{ert_system_domain_ssl_key}}|${ert_system_domain_ssl_key}|g" ${properties_json_file}
perl -pi -e "s|{{ert_apps_domain_ssl_cert}}|${ert_apps_domain_ssl_cert}|g" ${properties_json_file}
perl -pi -e "s|{{ert_apps_domain_ssl_key}}|${ert_apps_domain_ssl_key}|g" ${properties_json_file}
